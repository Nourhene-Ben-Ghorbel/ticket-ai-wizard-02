...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 font-['Space_Grotesk'] relative">
      ...
      <GlowingOrb className="top-1/4 left-1/4 -z-10" size={200} color="rgba(79, 70, 229, 0.15)" />
      <GlowingOrb className="bottom-1/4 right-1/4 -z-10" size={150} color="rgba(124, 58, 237, 0.1)" />
    </div>
  );
};
